<?php /* Smarty version 2.6.16, created on 2007-10-09 19:39:51
         compiled from gallery:modules/core/templates/AdminGroups.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'gallery:modules/core/templates/AdminGroups.tpl', 98, false),)), $this); ?>
...
<h3 class="giSuccess">
<?php if (isset ( $this->_tpl_vars['status']['deletedGroup'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Removed group '%s'",'arg1' => $this->_tpl_vars['status']['deletedGroup']), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['status']['createdGroup'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Created group '%s'",'arg1' => $this->_tpl_vars['status']['createdGroup']), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['status']['modifiedGroup'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Modified group '%s'",'arg1' => $this->_tpl_vars['status']['modifiedGroup']), $this);?>
...
"/>
<?php $this->_tag_stack[] = array('autoComplete', array('element' => 'giFormGroupname'), $this); $_block_repeat=true; $this->_reg_objects['g'][0]->autoComplete($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start(); echo $this->_reg_objects['g'][0]->url(array('arg1' => "view=core.SimpleCallback",'arg2' => "command=lookupGroupname",'arg3' => "prefix=__VALUE__",'htmlEntities' => false), $this);?>
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['noGroupSpecified'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => 'You must enter a group name'), $this);?>

</div>
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['cantDeleteGroup'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => 'You cannot delete that group'), $this);?>

</div>
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['cantEditGroupUsers'] )): ?>
<div class="giError">
...
<?php endif;  if (( $this->_tpl_vars['group']['can']['editUsers'] )): ?>
&nbsp;
