<?php /* Smarty version 2.6.10, created on 2006-09-19 11:31:30
         compiled from gallery:modules/core/templates/ItemPermissions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'gallery:modules/core/templates/ItemPermissions.tpl', 114, false),array('function', 'html_options', 'gallery:modules/core/templates/ItemPermissions.tpl', 154, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['deleteEntry']['description']; ?>
</option>
...
"/>
  <?php $this->_tag_stack[] = array('autoComplete', array('element' => 'giFormGroupname'), $this); $this->_reg_objects['g'][0]->autoComplete($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true); while ($_block_repeat) { ob_start();?>
...
"/>
  <?php $this->_tag_stack[] = array('autoComplete', array('element' => 'giFormUsername2'), $this); $this->_reg_objects['g'][0]->autoComplete($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true); while ($_block_repeat) { ob_start();?>
    <?php echo $this->_reg_objects['g'][0]->url(array('arg1' => "view=core.SimpleCallback",'arg2' => "command=lookupUsername",'arg3' => "prefix=__VALUE__",'htmlEntities' => false), $this);?>
