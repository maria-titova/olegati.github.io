<?php /* Smarty version 2.6.10, created on 2006-09-19 03:40:38
         compiled from gallery:themes/siriux/templates/photo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'markup', 'gallery:themes/siriux/templates/photo.tpl', 11, false),array('modifier', 'default', 'gallery:themes/siriux/templates/photo.tpl', 58, false),array('function', 'math', 'gallery:themes/siriux/templates/photo.tpl', 56, false),)), $this); ?>
...
"
   alt="<?php echo ((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['theme']['item']['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['theme']['item']['pathComponent']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['theme']['item']['pathComponent'])))) ? $this->_run_mod_handler('markup', true, $_tmp, 'strip') : smarty_modifier_markup($_tmp, 'strip')); ?>
"
...
<?php echo $this->_reg_objects['g'][0]->block(array('type' => "core.EmergencyEditItemLink",'class' => 'gbBlock','checkPhotoBlocks' => true), $this);?>
