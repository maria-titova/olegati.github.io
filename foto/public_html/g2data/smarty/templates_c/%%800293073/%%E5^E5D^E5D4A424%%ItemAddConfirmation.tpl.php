<?php /* Smarty version 2.6.16, created on 2007-10-09 19:02:25
...
<div class="gbBlock">
<h3>
<?php if (isset ( $this->_tpl_vars['ItemAddConfirmation']['count'] )):  echo $this->_reg_objects['g'][0]->text(array('one' => "Successfully added %d file.",'many' => "Successfully added %d files.",'count' => $this->_tpl_vars['ItemAddConfirmation']['count'],'arg1' => $this->_tpl_vars['ItemAddConfirmation']['count']), $this);?>

<?php else:  echo $this->_reg_objects['g'][0]->text(array('text' => "No files added."), $this);?>
...
<?php $_from = $this->_tpl_vars['ItemAddConfirmation']['status']['addedFiles']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
 ...
 if ($this->_tpl_vars['entry']['exists']):  ob_start(); ?>
...
<?php $this->_smarty_vars['capture']['itemLink'] = ob_get_contents(); ob_end_clean();  echo $this->_reg_objects['g'][0]->text(array('text' => "Added %s",'arg1' => $this->_smarty_vars['capture']['itemLink']), $this);?>

<?php else:  echo $this->_reg_objects['g'][0]->text(array('text' => "Failed to add %s",'arg1' => $this->_tpl_vars['entry']['fileName']), $this);?>
