<?php /* Smarty version 2.6.16, created on 2007-10-09 19:43:09
         compiled from gallery:modules/core/templates/AdminUsers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'gallery:modules/core/templates/AdminUsers.tpl', 98, false),)), $this); ?>
...
<h3 class="giSuccess">
<?php if (isset ( $this->_tpl_vars['status']['deletedUser'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Removed user '%s'",'arg1' => $this->_tpl_vars['status']['deletedUser']), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['status']['createdUser'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Created user '%s'",'arg1' => $this->_tpl_vars['status']['createdUser']), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['status']['modifiedUser'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Modified user '%s'",'arg1' => $this->_tpl_vars['status']['modifiedUser']), $this);?>
...
"/>
<?php $this->_tag_stack[] = array('autoComplete', array('element' => 'giFormUsername'), $this); $_block_repeat=true; $this->_reg_objects['g'][0]->autoComplete($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start(); echo $this->_reg_objects['g'][0]->url(array('arg1' => "view=core.SimpleCallback",'arg2' => "command=lookupUsername",'arg3' => "prefix=__VALUE__",'htmlEntities' => false), $this);?>
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['noUserSpecified'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => 'You must enter a username'), $this);?>

</div>
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['cantDeleteSelf'] )): ?>
<div class="giError">
<?php echo $this->_reg_objects['g'][0]->text(array('text' => "You cannot delete yourself!"), $this);?>

</div>
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['text']['cantDeleteAnonymous'] )): ?>
<div class="giError">
...
<th> <?php echo $this->_reg_objects['g'][0]->text(array('text' => 'Locked'), $this);?>
 </th>
<th> <?php echo $this->_reg_objects['g'][0]->text(array('text' => 'Failed Logins'), $this);?>
 </th>
...
<td>
<?php if ($this->_tpl_vars['user']['locked']):  echo $this->_reg_objects['g'][0]->text(array('text' => 'locked'), $this);?>
...
<td>
<?php if ($this->_tpl_vars['user']['failedLogins']): ?>
<span class="giWarning"><?php echo $this->_tpl_vars['user']['failedLogins']; ?>
</span>
<?php else: ?>
&nbsp;
<?php endif; ?>
...
"/>
<?php endif;  if (( ! empty ( $this->_tpl_vars['form']['list']['filter'] ) )): ?>
