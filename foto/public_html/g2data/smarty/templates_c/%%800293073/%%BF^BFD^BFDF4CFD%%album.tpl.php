<?php /* Smarty version 2.6.10, created on 2006-09-19 03:19:24
         compiled from gallery:themes/classic/templates/album.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'markup', 'gallery:themes/classic/templates/album.tpl', 21, false),array('modifier', 'entitytruncate', 'gallery:themes/classic/templates/album.tpl', 113, false),array('modifier', 'indent', 'gallery:themes/classic/templates/album.tpl', 145, false),array('modifier', 'default', 'gallery:themes/classic/templates/album.tpl', 150, false),)), $this); ?>
...
?>
		...
		<div>
		  <?php if (isset ( $this->_tpl_vars['theme']['params'][$this->_tpl_vars['frameType']] ) && isset ( $this->_tpl_vars['child']['thumbnail'] )): ?>
		    <?php $this->_tag_stack[] = array('container', array('type' => "imageframe.ImageFrame",'frame' => $this->_tpl_vars['theme']['params'][$this->_tpl_vars['frameType']],'width' => $this->_tpl_vars['child']['thumbnail']['width'],'height' => $this->_tpl_vars['child']['thumbnail']['height']), $this); $this->_reg_objects['g'][0]->container($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true); while ($_block_repeat) { ob_start();?>
