<?php /* Smarty version 2.6.16, created on 2007-10-11 15:49:03
         compiled from gallery:modules/core/templates/AdminCore.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gallery:modules/core/templates/AdminCore.tpl', 47, false),)), $this); ?>
...
<?php if (isset ( $this->_tpl_vars['status']['saved'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => 'Settings saved successfully'), $this);?>
 <br/>
<?php endif;  if (isset ( $this->_tpl_vars['status']['addedDir'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => 'Added local upload directory successfully'), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['status']['removedDir'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => 'Removed local upload directory successfully'), $this);?>

<?php endif;  if (isset ( $this->_tpl_vars['status']['emailTestSuccess'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => 'Test email sent successfully'), $this);?>
...
<?php $this->_smarty_vars['capture']['gettext'] = ob_get_contents(); ob_end_clean();  echo $this->_reg_objects['g'][0]->text(array('text' => "Your webserver does not support localization.  Please instruct your system administrator to reconfigure PHP with the %s option enabled.",'arg1' => $this->_smarty_vars['capture']['gettext']), $this);?>
...
<?php endif;  if (isset ( $this->_tpl_vars['status']['emailTestError'] )): ?>
