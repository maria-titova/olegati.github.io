...
">
<?php if (count ( $this->_tpl_vars['theme']['imageViews'] ) > 1):  echo $this->_reg_objects['g'][0]->text(array('text' => "Size: "), $this);?>
...
?>
<option value="<?php echo $this->_reg_objects['g'][0]->url(array('params' => $this->_tpl_vars['theme']['pageUrl'],'arg1' => "itemId=".($this->_tpl_vars['theme']['item']['id']),'arg2' => "imageViewsIndex=".($this->_sections['imageView']['index'])), $this);?>
"<?php if ($this->_sections['imageView']['index'] == $this->_tpl_vars['theme']['imageViewsIndex']): ?> selected="selected"<?php endif; ?>>
<?php if (empty ( $this->_tpl_vars['theme']['imageViews'][$this->_sections['imageView']['index']]['width'] )):  if (isset ( $this->_tpl_vars['theme']['imageViews'][$this->_sections['imageView']['index']]['isSource'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => 'Source'), $this);?>

<?php else:  echo $this->_reg_objects['g'][0]->text(array('text' => 'Unknown'), $this);?>

<?php endif;  else:  echo $this->_reg_objects['g'][0]->text(array('text' => "%dx%d",'arg1' => $this->_tpl_vars['theme']['imageViews'][$this->_sections['imageView']['index']]['width'],'arg2' => $this->_tpl_vars['theme']['imageViews'][$this->_sections['imageView']['index']]['height']), $this);?>
...
<br/>
<?php endif;  if (! empty ( $this->_tpl_vars['theme']['sourceImage'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Full size: "), $this);?>

<?php ob_start();  if (empty ( $this->_tpl_vars['theme']['sourceImage']['width'] )):  echo $this->_tpl_vars['theme']['sourceImage']['itemTypeName']['0']; ?>

<?php else:  echo $this->_reg_objects['g'][0]->text(array('text' => "%dx%d",'arg1' => $this->_tpl_vars['theme']['sourceImage']['width'],'arg2' => $this->_tpl_vars['theme']['sourceImage']['height']), $this);?>

<?php endif;  $this->_smarty_vars['capture']['fullSize'] = ob_get_contents(); ob_end_clean();  if (count ( $this->_tpl_vars['theme']['imageViews'] ) > 1): ?>
<a href="<?php echo $this->_reg_objects['g'][0]->url(array('params' => $this->_tpl_vars['theme']['pageUrl'],'arg1' => "itemId=".($this->_tpl_vars['theme']['item']['id']),'arg2' => "imageViewsIndex=".($this->_tpl_vars['theme']['sourceImageViewIndex'])), $this);?>
">
<?php echo $this->_smarty_vars['capture']['fullSize']; ?>

</a>
<?php else:  echo $this->_smarty_vars['capture']['fullSize']; ?>
