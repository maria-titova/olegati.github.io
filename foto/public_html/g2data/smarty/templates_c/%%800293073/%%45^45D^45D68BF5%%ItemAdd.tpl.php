...
<?php ob_start();  echo $this->_reg_objects['g'][0]->url(array('arg1' => "view=core.SiteAdmin",'arg2' => "subView=core.AdminPlugins"), $this);?>

<?php $this->_smarty_vars['capture']['url'] = ob_get_contents(); ob_end_clean();  if ($this->_tpl_vars['ItemAdd']['isAdmin']):  echo $this->_reg_objects['g'][0]->text(array('text' => "Visit the <a href=\"%s\">Modules</a> page to activate a Graphics Toolkit.",'arg1' => $this->_smarty_vars['capture']['url']), $this);?>
