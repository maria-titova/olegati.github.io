...
unset($_smarty_tpl_vars);
  if (isset ( $this->_tpl_vars['ThemeSettingsForm']['customTemplate'] )):  $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  endif;  if (! empty ( $this->_tpl_vars['ThemeSettingsForm']['settings'] )): ?>
...
<?php $_from = $this->_tpl_vars['ThemeSettingsForm']['settings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
 ...
 $this->assign('settingKey', $this->_tpl_vars['setting']['key']); ?>
