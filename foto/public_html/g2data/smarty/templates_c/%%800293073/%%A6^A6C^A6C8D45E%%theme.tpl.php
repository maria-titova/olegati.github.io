<?php /* Smarty version 2.6.16, created on 2007-10-09 20:08:35
         compiled from gallery:themes/tile/templates/theme.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'gallery:themes/tile/templates/theme.tpl', 14, false),array('modifier', 'markup', 'gallery:themes/tile/templates/theme.tpl', 14, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['theme']['pageType'] == 'album' || $this->_tpl_vars['theme']['pageType'] == 'photo'):  echo $this->_reg_objects['g'][0]->theme(array('include' => "tile.tpl"), $this);?>

<?php elseif ($this->_tpl_vars['theme']['pageType'] == 'admin'):  $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  elseif ($this->_tpl_vars['theme']['pageType'] == 'progressbar'):  echo $this->_reg_objects['g'][0]->theme(array('include' => "progressbar.tpl"), $this);?>
