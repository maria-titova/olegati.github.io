<?php /* Smarty version 2.6.16, created on 2007-10-09 19:32:46
         compiled from gallery:modules/core/templates/ItemEditTheme.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gallery:modules/core/templates/ItemEditTheme.tpl', 20, false),)), $this); ?>
<div class="gbBlock">
...
<?php if (! empty ( $this->_tpl_vars['ThemeSettingsForm'] )):  ob_start(); ?><h3><?php echo $this->_reg_objects['g'][0]->text(array('text' => "Configure the %s theme",'arg1' => "<b>".($this->_tpl_vars['ThemeSettingsForm']['theme']['name'])."</b>"), $this);?>
</h3>
<?php echo $this->_reg_objects['g'][0]->text(array('text' => "These settings only apply to the theme for this album."), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('message', ob_get_contents());ob_end_clean();  echo $this->_reg_objects['g'][0]->block(array('type' => "core.ThemeSettingsForm",'class' => 'gbBlock','message' => $this->_tpl_vars['message'],'formId' => 'itemAdminForm'), $this);?>
