<?php /* Smarty version 2.6.16, created on 2007-10-09 20:07:40
         compiled from gallery:themes/floatrix/templates/theme.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'markup', 'gallery:themes/floatrix/templates/theme.tpl', 14, false),array('modifier', 'default', 'gallery:themes/floatrix/templates/theme.tpl', 14, false),)), $this); ?>
...
"/>
<script type="text/javascript" src="<?php echo $this->_reg_objects['g'][0]->theme(array('url' => "functions.js"), $this);?>
"></script>
</head>
<body class="gallery">
...
<?php if (! empty ( $this->_tpl_vars['theme']['params']['sidebarBlocks'] ) && $this->_tpl_vars['theme']['pageType'] != 'admin'): ?>
...
<?php endif;  if ($this->_tpl_vars['theme']['pageType'] == 'album'):  echo $this->_reg_objects['g'][0]->theme(array('include' => "album.tpl"), $this);?>
