<?php /* Smarty version 2.6.16, created on 2007-10-09 19:38:30
         compiled from gallery:modules/core/templates/UserPreferences.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'gallery:modules/core/templates/UserPreferences.tpl', 53, false),)), $this); ?>
...
<?php if (! isset ( $this->_tpl_vars['UserAdmin']['isSiteAdmin'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "(required, password required for change)"), $this);?>

<?php else:  echo $this->_reg_objects['g'][0]->text(array('text' => "(suggested, password required for change)"), $this);?>
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['email']['invalid'] )): ?>
<div class="giError">
...
<?php endif;  if (isset ( $this->_tpl_vars['form']['error']['currentPassword']['incorrect'] )): ?>
<div class="giError">
