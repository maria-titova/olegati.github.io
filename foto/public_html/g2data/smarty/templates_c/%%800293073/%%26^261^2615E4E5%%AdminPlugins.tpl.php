<?php /* Smarty version 2.6.16, created on 2007-10-09 19:35:31
         compiled from gallery:modules/core/templates/AdminPlugins.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'gallery:modules/core/templates/AdminPlugins.tpl', 11, false),array('modifier', 'capitalize', 'gallery:modules/core/templates/AdminPlugins.tpl', 152, false),array('function', 'cycle', 'gallery:modules/core/templates/AdminPlugins.tpl', 147, false),)), $this); ?>
...
<?php $this->_smarty_vars['capture']['getMoreLink'] = ob_get_contents(); ob_end_clean();  echo $this->_smarty_vars['capture']['getMoreLink']; ?>
...
<?php $this->assign('group', "");  $_from = $this->_tpl_vars['AdminPlugins']['plugins']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['plugin']):
 if ($this->_tpl_vars['group'] != $this->_tpl_vars['plugin']['group']):  if (! empty ( $this->_tpl_vars['group'] )): ?>
<tr><td> &nbsp; </td></tr>
<?php endif; ?>
<tr>
...
<?php endif;  $this->assign('group', $this->_tpl_vars['plugin']['group']); ?>
...
&nbsp;</a></div>
<?php if (empty ( $this->_tpl_vars['plugin']['screenshot'] )):  echo $this->_tpl_vars['plugin']['name']; ?>

<?php else: ?>
<span class="gTooltipTarget"><?php echo $this->_tpl_vars['plugin']['name']; ?>
</span>
<?php ob_start();  echo $this->_reg_objects['g'][0]->text(array('text' => "Screenshot for %s",'arg1' => $this->_tpl_vars['plugin']['name']), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('screenshotLabel', ob_get_contents());ob_end_clean(); ?>
<script type="text/javascript">
// <![CDATA[
...
<?php endif;  if ($this->_tpl_vars['plugin']['api']['required']['plugin'] != $this->_tpl_vars['plugin']['api']['provided']['plugin']): ?>
<br/>
...
<?php if (( $this->_tpl_vars['plugin']['type'] == 'module' && $this->_tpl_vars['plugin']['id'] == 'core' ) || $this->_tpl_vars['plugin']['state'] == 'incompatible' || ( $this->_tpl_vars['plugin']['type'] == 'theme' && $this->_tpl_vars['plugin']['id'] == $this->_tpl_vars['AdminPlugins']['defaultTheme'] && $this->_tpl_vars['plugin']['state'] == 'active' )): ?>
&nbsp;
<?php else: ?>
