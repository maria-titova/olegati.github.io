<?php /* Smarty version 2.6.16, created on 2007-10-11 15:47:18
...
<div>
<?php if (isset ( $this->_tpl_vars['theme']['params'][$this->_tpl_vars['frameType']] ) && isset ( $this->_tpl_vars['child']['thumbnail'] )):  $this->_tag_stack[] = array('container', array('type' => "imageframe.ImageFrame",'frame' => $this->_tpl_vars['theme']['params'][$this->_tpl_vars['frameType']],'width' => $this->_tpl_vars['child']['thumbnail']['width'],'height' => $this->_tpl_vars['child']['thumbnail']['height']), $this); $_block_repeat=true; $this->_reg_objects['g'][0]->container($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>
...
<p class="giTitle">
<?php if ($this->_tpl_vars['child']['canContainChildren'] && ( ! isset ( $this->_tpl_vars['theme']['params']['albumFrame'] ) || $this->_tpl_vars['theme']['params']['albumFrame'] == $this->_tpl_vars['theme']['params']['itemFrame'] )):  echo $this->_reg_objects['g'][0]->text(array('text' => "Album: %s",'arg1' => ((is_array($_tmp=$this->_tpl_vars['child']['title'])) ? $this->_run_mod_handler('markup', true, $_tmp) : smarty_modifier_markup($_tmp))), $this);?>

<?php else:  echo ((is_array($_tmp=$this->_tpl_vars['child']['title'])) ? $this->_run_mod_handler('markup', true, $_tmp) : smarty_modifier_markup($_tmp)); ?>

<?php endif; ?>
</p>
<?php endif;  if (! empty ( $this->_tpl_vars['child']['summary'] )): ?>
<p class="giDescription">
...
<?php endif;  if (! empty ( $this->_tpl_vars['theme']['navigator'] )): ?>
<div class="gbBlock gcBackground2 gbNavigator">
<?php echo $this->_reg_objects['g'][0]->block(array('type' => "core.Navigator",'navigator' => $this->_tpl_vars['theme']['navigator'],'reverseOrder' => true), $this);?>

</div>
<?php endif;  if (! empty ( $this->_tpl_vars['theme']['jumpRange'] )): ?>
...
</table>ype' => $this->_tpl_vars['block']['0'],'params' => $this->_tpl_vars['block']['1']), $this);?>
