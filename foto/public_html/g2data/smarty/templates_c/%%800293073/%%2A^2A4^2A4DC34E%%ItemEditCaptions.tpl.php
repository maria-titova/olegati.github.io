<?php /* Smarty version 2.6.16, created on 2007-10-09 19:34:09
...
<?php if (( $this->_tpl_vars['ItemEditCaptions']['numPages'] > 1 )):  echo $this->_reg_objects['g'][0]->text(array('text' => "(page %d of %d)",'arg1' => $this->_tpl_vars['ItemEditCaptions']['page'],'arg2' => $this->_tpl_vars['ItemEditCaptions']['numPages']), $this);?>
...
<h2 class="giError">
<?php if ($this->_tpl_vars['status']['successCount'] > 0):  echo $this->_reg_objects['g'][0]->text(array('text' => 'There were errors saving some items'), $this);?>

<?php else:  echo $this->_reg_objects['g'][0]->text(array('text' => 'There were errors saving all items'), $this);?>
...
<?php endif;  if (empty ( $this->_tpl_vars['form']['items'] )): ?>
<div class="gbBlock">
...
"/>
<?php if (isset ( $this->_tpl_vars['item']['thumbnail'] )):  echo '<div style="float: right"><a id="thumb_';  echo $this->_tpl_vars['item']['id'];  echo '" href="';  echo $this->_reg_objects['g'][0]->url(array('arg1' => "view=core.ShowItem",'arg2' => "itemId=".($this->_tpl_vars['item']['id'])), $this); echo '">';  echo $this->_reg_objects['g'][0]->image(array('item' => $this->_tpl_vars['item'],'image' => $this->_tpl_vars['item']['thumbnail'],'maxSize' => 150,'class' => 'giThumbnail'), $this); echo '</a></div>';  endif; ?>
...
<?php endif;  if (isset ( $this->_tpl_vars['status'][$this->_tpl_vars['item']['id']]['obsolete'] )): ?>
<div class="giError">
...
<?php endif;  if (isset ( $this->_tpl_vars['status'][$this->_tpl_vars['item']['id']]['permissionDenied'] )): ?>
<div class="giError">
...
<?php $_from = $this->_tpl_vars['form']['items']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
 if (isset ( $this->_tpl_vars['item']['resize'] )): ?>
...
"/>
<?php endif;  if (( $this->_tpl_vars['ItemEditCaptions']['page'] > 1 )): ?>
<input type="submit" class="inputTypeSubmit"
...
"/>
<?php endif;  if (( $this->_tpl_vars['ItemEditCaptions']['page'] < $this->_tpl_vars['ItemEditCaptions']['numPages'] )): ?>
<input type="submit" class="inputTypeSubmit"
...
value="<?php echo $this->_reg_objects['g'][0]->text(array('text' => "Save and Edit Next %s",'arg1' => $this->_tpl_vars['form']['numPerPage']), $this);?>
 &raquo;"/>
<?php endif;  if ($this->_tpl_vars['ItemEditCaptions']['canCancel']): ?>
<input type="submit" class="inputTypeSubmit"
